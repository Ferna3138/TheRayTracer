	...
	std::for_each(std::execution::par ,m_ImageVerticalIter.begin(), m_ImageVerticalIter.end(),
		[this](uint32_t y) {
			...
			[this, y](uint32_t x) {
					...
					accumulatedColour = glm::clamp(accumulatedColour, glm::vec4(0.0f), glm::vec4(1.0f)); //Make sure colour stays within 0 and 1
